from resume_enhancer.src.constants import GARAMOND_REGULAR, GARAMOND_SEMIBOLD
...
NAME_PARAGRAPH_STYLE = ParagraphStyle('name_paragraph', fontName = GARAMOND_SEMIBOLD, fontSize=16,alignment=TA_CENTER)
